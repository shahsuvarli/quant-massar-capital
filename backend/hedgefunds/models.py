...
class HedgeFundCompany(models.Model):
    ...
    manager = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="managed_funds")
...
class Fund(models.Model):
    id = models.UUIDField(
        primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(max_length=200)
    hedge_fund_company = models.ForeignKey(
        HedgeFundCompany, on_delete=models.CASCADE, related_name="funds")
    inception_date = models.DateField()
    total_aum = models.DecimalField(max_digits=20, decimal_places=2)
...
class Portfolio(models.Model):
    ...
    fund = models.ForeignKey(
        Fund, on_delete=models.CASCADE, related_name="portfolios")
    name = models.CharField(max_length=200)
    manager = models.ForeignKey(
