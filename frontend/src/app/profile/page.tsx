          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <div className="relative drop-shadow-2">
                <Image
                  ...
                  alt="profile"
                  className="rounded-full grayscale-[20%] opacity-90"
                />
                <label
                  htmlFor="profile"
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                  I am a highly skilled quantitative software engineer specializing in data analysis, algorithm design, and software development. With expertise in languages such as Python, Javascript, and Typescript, I develop robust systems for processing large datasets, implementing statistical models, and deploying machine learning algorithms. My experience spans asset pricing, financial modeling, and predictive analytics, and I am proficient in working with databases and cloud infrastructures to optimize solutions.
                </p>
              </div>
